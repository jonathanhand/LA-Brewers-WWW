...
var Place = /** @class */ (function () {
    function Place(id, title, description, image) {
        this.id = id;
        this.title = title;
...
/* harmony import */ var _place_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./place.model */ "./src/app/tab1/place.model.ts");
...
var PlaceService = /** @class */ (function () {
    function PlaceService(http) {
        this.http = http;
        this._places = [
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p1', 'L.A. Brewers Win Big', 
            ...
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p2', 'L.A. Brewers Take Home Six GABF Medals', '2018 Great American Beer Festival held in Denver, Colorado', '../assets/brew-imgs/medals.png'),
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p3', 'Griffith Park Run 5k', 'Independent Beer Garden Run', '../assets/brew-imgs/5krun.jpg'),
        ];
    }
    ...
    PlaceService.prototype.addPlace = function (title, description, price, dateFrom, dateTo) {
        var newPlace = new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"](Math.random().toString(), title, description, '../assets/imgs/nyc.jpg');
        this.http.post('https://beachbnb-93d74.firebaseio.com/place.json', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, newPlace, { id: null }))
    ...
    PlaceService.prototype.updateOffer = function (placeId, title, description) {
        ...
        updatedPlace[updatedPlaceIndex] = new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"](oldPlace.id, title, description, oldPlace.image);
...
/***/ "./src/app/tab2/breweries.service.ts":
/*!*******************************************!*\
  !*** ./src/app/tab2/breweries.service.ts ***!
  \*******************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _brewery_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./brewery.model */ "./src/app/tab2/brewery.model.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
...
var BreweryService = /** @class */ (function () {
    ...
    BreweryService.prototype.getBreweries = function () {
        ...
        this.http.get('https://la-brewers.firebaseio.com/breweries.json')
            ...
            for (var j in res) {
                var newBrewery = new _brewery_model__WEBPACK_IMPORTED_MODULE_2__["Brewery"](j, res[j].name, res[j].address, res[j].location, res[j].lat, res[j].lng);
    ...
    BreweryService.prototype.getPlace = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._breweries.find(function (b) { return b.id === id; }));
    };
    BreweryService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
...
/***/ "./src/app/tab2/brewery.model.ts":
/*!***************************************!*\
  !*** ./src/app/tab2/brewery.model.ts ***!
  \***************************************/
/*! exports provided: Brewery */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Brewery", function() { return Brewery; });
var Brewery = /** @class */ (function () {
    function Brewery(id, name, address, location, lat, lng) {
        this.id = id;
        this.name = name;
